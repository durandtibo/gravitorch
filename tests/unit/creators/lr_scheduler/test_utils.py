...
def test_setup_lr_scheduler_creator_none():
    assert isinstance(setup_lr_scheduler_creator(None), VanillaLRSchedulerCreator)


def test_setup_lr_scheduler_creator_object():
...
def test_setup_lr_scheduler_creator_dict():
    assert isinstance(
        setup_lr_scheduler_creator(
            {
...
def test_setup_lr_scheduler_creator_dict_mock():
