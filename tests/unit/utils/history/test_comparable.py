...
def test_comparable_history_str_name():
    assert (
...
def test_comparable_history_max_size_incorrect():
    with raises(ValueError):
        ComparableHistory[Number]("accuracy", MaxScalarComparator(), max_size=0)


def test_comparable_history_add_value():
...
def test_comparable_history_get_best_value():
    assert (
        ComparableHistory[Number](
...
def test_comparable_history_get_best_value_last_is_best():
...
def test_comparable_history_get_best_value_last_is_not_best():
    history = ComparableHistory[Number]("accuracy", comparator=MaxScalarComparator())
    history.add_value(2, step=0)
...
def test_comparable_history_get_last_value():
    assert (
        ComparableHistory(
            "accuracy",
            comparator=MaxScalarComparator(),
...
def test_comparable_history_get_last_value_empty():
    history = ComparableHistory("accuracy", comparator=MaxScalarComparator())
    with raises(EmptyHistoryError):
        history.get_last_value()


def test_comparable_history_has_improved_true():
    history = ComparableHistory[Number]("accuracy", comparator=MaxScalarComparator())
    history.add_value(2, step=0)
    history.add_value(4, step=1)
...
def test_comparable_history_has_improved_false():
    history = ComparableHistory[Number]("accuracy", comparator=MaxScalarComparator())
    history.add_value(2, step=0)
    history.add_value(1, step=1)
...
def test_comparable_history_config_dict_create_new_history():
...
def test_comparable_history_load_state_dict_empty():
    history = ComparableHistory("accuracy", comparator=MaxScalarComparator())
...
def test_comparable_history_load_state_dict_max_size_2():
...
def test_comparable_history_load_state_dict_reset():
...
def test_comparable_history_state_dict():
...
def test_comparable_history_state_dict_empty():
...
def test_comparable_history_to_dict_from_dict():
...
def test_max_scalar_history_equal_true():
...
def test_max_scalar_history_equal_true_empty():
    assert MaxScalarHistory("accuracy").equal(MaxScalarHistory("accuracy"))


def test_max_scalar_history_equal_false_different_values():
...
def test_max_scalar_history_equal_false_different_names():
    assert not MaxScalarHistory("accuracy").equal(MaxScalarHistory("f1"))


def test_max_scalar_history_equal_false_different_max_sizes():
    assert not MaxScalarHistory("accuracy").equal(MaxScalarHistory("accuracy", max_size=2))


def test_max_scalar_history_equal_false_different_types():
    assert not MaxScalarHistory("accuracy").equal(MinScalarHistory("accuracy"))


def test_max_scalar_get_best_value_last_is_best():
...
def test_max_scalar_get_best_value_last_is_not_best():
    history = MaxScalarHistory("accuracy")
    history.add_value(2, step=0)
    history.add_value(1, step=1)
    assert history.get_best_value() == 2
...
def test_max_scalar_to_dict_from_dict():
    assert BaseHistory.from_dict(
        MaxScalarHistory(
...
def test_min_scalar_history_equal_true():
...
def test_min_scalar_history_equal_true_empty():
    assert MinScalarHistory("loss").equal(MinScalarHistory("loss"))


def test_min_scalar_history_equal_false_different_values():
...
def test_min_scalar_history_equal_false_different_names():
    assert not MinScalarHistory("loss").equal(MinScalarHistory("error"))


def test_min_scalar_history_equal_false_different_max_sizes():
    assert not MinScalarHistory("loss").equal(MinScalarHistory("loss", max_size=2))


def test_min_scalar_history_equal_false_different_types():
    assert not MinScalarHistory("loss").equal(MaxScalarHistory("loss"))


def test_min_scalar_get_best_value_last_is_best():
...
def test_min_scalar_get_best_value_last_is_not_best():
    history = MinScalarHistory("loss")
    history.add_value(2, step=0)
    history.add_value(4, step=1)
    assert history.get_best_value() == 2
...
def test_min_scalar_to_dict_from_dict():
    assert BaseHistory.from_dict(
        MinScalarHistory(
