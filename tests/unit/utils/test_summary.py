...
def test_concise_summary_torch_tensor_float() -> None:
...
def test_concise_summary_torch_tensor_long() -> None:
...
def test_concise_summary_int() -> None:
    assert concise_summary(35) == "<class 'int'> | value=35"


def test_concise_summary_float() -> None:
    assert concise_summary(1.5) == "<class 'float'> | value=1.5"


def test_concise_summary_str() -> None:
